...
# Predictions from the final log-yield model,
# varying the centered interrow biomass covariate
pred_interrow <- ggpredict(
  yield_cov_mod_final,
  terms = "interrow_center [all]"
)

ggplot(pred_interrow, aes(x = x, y = predicted)) +
  # 95% CI ribbon
  geom_ribbon(
  ...
  labs(
    ...
    subtitle = "Predictions from log-yield mixed model,\naveraged over weed management and site-years"
  ) +
