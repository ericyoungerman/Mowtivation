...
![](figs/analysis/bean_100_weight-unnamed-chunk-3-1.png)<!-- -->
...
```
    ...
    ## Data: hundred_sw_clean
    ## Models:
    ## sw_add: seed_weight ~ weed_trt + site_year + (1 | site_year:block)
    ## sw_int: seed_weight ~ weed_trt * site_year + (1 | site_year:block)
    ##        npar    AIC    BIC  logLik -2*log(L)  Chisq Df Pr(>Chisq)  
    ## sw_add    9 90.052 108.90 -36.026    72.052                       
    ## sw_int   17 90.718 126.32 -28.359    56.718 15.335  8    0.05296 .
    ## ---
...
![](figs/analysis/bean_100_weight-unnamed-chunk-4-1.png)<!-- -->

``` r
DHARMa::testDispersion(sw.lmer)
```

![](figs/analysis/bean_100_weight-unnamed-chunk-4-2.png)<!-- -->
...
![](figs/analysis/bean_100_weight-unnamed-chunk-7-1.png)<!-- -->
...
![](figs/analysis/bean_100_weight-unnamed-chunk-8-1.png)<!-- -->
